...
<body>
  ...
  <ul>
    <li><strong>Climbing advice and knowledge</strong> based on books and other official resources that could be useful for your own climbing journey. Topics that are covered are strength training, nutrition and climbing technique. Sometimes, all we need is a single place to keep everything together, like a notebook.</li>
